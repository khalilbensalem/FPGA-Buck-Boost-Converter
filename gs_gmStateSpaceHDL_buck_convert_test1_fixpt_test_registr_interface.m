...
% 
% Generated with MATLAB 25.1 (R2025a) at 04:04:58 on 12/04/2026.
% This script was created for the IP Core generated from design 'gmStateSpaceHDL_buck_convert_test1_fixpt_test_registr'.
% 
...
% programFPGA(hProcessor, "C:\Users\bensa\Desktop\PI3_FPGA_BuckConverter\TESTT_VF_fixpt_AXI_test\hdl_Buck\vivado_ip_prj\vivado_prj.runs\impl_1\design_1_wrapper.bit", "");
...
gs_gmStateSpaceHDL_buck_convert_test1_fixpt_test_registr_setup(hFPGA);
...
% data_pwm_axi1 = readPort(hFPGA, "pwm_axi1");
% data_error_axi2 = readPort(hFPGA, "error_axi2");
