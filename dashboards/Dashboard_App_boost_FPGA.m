classdef Dashboard_App_boost_FPGA < matlab.apps.AppBase 
    ...
    properties (Access = public)
        ...
        VoutCalcLabel               matlab.ui.control.Label
    ...
    properties (Access = private)
        MODEL_NAME = 'gm_gmStateSpaceHDL_boost_convert_fixpt_interface'
    end
    ...
    methods (Access = private)
        ...
        function updateDisplayedValues(app)
            vout_calc = 5 / (1 - app.DutyKnob.Value);

            app.DutyValueLabel.Text = sprintf('Duty = %.3f', app.DutyKnob.Value);
            app.VoutCalcLabel.Text  = sprintf('Vout = %.2f V', vout_calc);
        ...
        function createComponents(app)
            ...
            app.UIFigure.Name = 'Control Dashboard Boost FPGA';
            ...
            app.TitleLabel.Text = 'Control Dashboard Boost FPGA';
            ...
            app.VrefSlider.Limits = [5 10];
            app.VrefSlider.MajorTicks = 5:1:10;
            ...
            app.FreqValueLabel.Text = 'Freq = 50300 Hz';
            ...
            % Row 6 : Extra info + Mode label
            app.VoutCalcLabel = uilabel(app.MainGrid);
            app.VoutCalcLabel.Text = 'Vout = 12(1 - D) = 6.00 V';
            app.VoutCalcLabel.HorizontalAlignment = 'center';
            app.VoutCalcLabel.FontSize = 12;
            app.VoutCalcLabel.FontColor = [0.25 0.75 1.00];
            app.VoutCalcLabel.Layout.Row = 6;
            app.VoutCalcLabel.Layout.Column = 1;
    ...
    methods (Access = public)
        ...
        function app = Dashboard_App_boost_FPGA
