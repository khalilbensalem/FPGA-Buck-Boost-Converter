classdef Dashboard_App_buck_cpu < matlab.apps.AppBase
    ...
    properties (Access = private)
        MODEL_NAME = 'gmStateSpaceHDL_buck_convert_test1_fixpt_test_registr'
    end
    ...
    methods (Access = private)
        ...
        %  Row 8  : StopTimeLabel col 3
        %  Row 9  : StopTimeField col 3
        %  Row 10 : StopTimeValueLabel col 3
        %  Row 11 : Separateur + label Scopes
        ...
        function createComponents(app)
            ...
            app.UIFigure.Name = 'Control Dashboard Buck CPU';
            ...
            app.TitleLabel.Text = 'Control Dashboard Buck CPU';
            ...
            % Scope_Output  (rouge dans ton schéma → on met un bleu scope)
            ...
            % Scope_PWM  (vert dans ton schéma)
            ...
            % Scope_controller  (rouge dans ton schéma)
    ...
    methods (Access = public)
        ...
        function app = Dashboard_App_buck_cpu
